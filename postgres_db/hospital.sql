...
( patient_id, first_name, last_name, gender, date_of_birth, contact_number, email) values (1, 'Hall', 'Louch', 'Male', '14/3/2023', '941 409 7803', 'hlouch0@army.mil'),
 ( patient_id, first_name, last_name, gender, date_of_birth, contact_number, email) values (2, 'Gard', 'Davie', 'Male', '21/4/2023', '580 555 7554', 'gdavie1@columbia.edu'),
 ( patient_id, first_name, last_name, gender, date_of_birth, contact_number, email) values (3, 'Annelise', 'Walley', 'Female', '23/12/2023', '876 219 3596', 'awalley2@go.com'),
 ( patient_id, first_name, last_name, gender, date_of_birth, contact_number, email) values (4, 'Dyann', 'Draycott', 'Genderfluid', '21/1/2024', '296 996 2382', 'ddraycott3@icq.com'),
 ( patient_id, first_name, last_name, gender, date_of_birth, contact_number, email) values (5, 'Cristobal', 'Southerill', 'Male', '22/3/2023', '596 466 1407', 'csoutherill4@soup.io'),
 ( patient_id, first_name, last_name, gender, date_of_birth, contact_number, email) values (6, 'Lucinda', 'Rewcassell', 'Female', '21/7/2023', '299 555 0510', 'lrewcassell5@msu.edu'),
 ( patient_id, first_name, last_name, gender, date_of_birth, contact_number, email) values (7, 'Andie', 'Fisher', 'Genderfluid', '24/12/2023', '211 963 2485', 'afisher6@skype.com'),
 ( patient_id, first_name, last_name, gender, date_of_birth, contact_number, email) values (8, 'Nickola', 'O''Shea', 'Male', '9/12/2023', '772 386 4213', 'noshea7@un.org'),
 ( patient_id, first_name, last_name, gender, date_of_birth, contact_number, email) values (9, 'Otes', 'Currm', 'Male', '29/11/2023', '554 446 9062', 'ocurrm8@simplemachines.org'),
...
insert into doctors (doctor_id, first_name, last_name, specialty, contact_number, email) values (101, 'Gwenore', 'Biskupek', 'Orthopedics', '457 465 2481', 'gbiskupek0@typepad.com');
insert into doctors (doctor_id, first_name, last_name, specialty, contact_number, email) values (102, 'Deck', 'Dauber', 'Dermatology', '379 630 7750', 'ddauber1@360.cn');
insert into doctors (doctor_id, first_name, last_name, specialty, contact_number, email) values (103, 'Enrico', 'Plan', 'Oncology', '584 141 8343', 'eplan2@51.la');
insert into doctors (doctor_id, first_name, last_name, specialty, contact_number, email) values (104, 'Philippa', 'Ivkovic', 'Dermatology', '212 539 4054', 'pivkovic3@odnoklassniki.ru');
insert into doctors (doctor_id, first_name, last_name, specialty, contact_number, email) values (105, 'Kira', 'Moan', 'Neurology', '512 423 4504', 'kmoan4@youku.com');
insert into doctors (doctor_id, first_name, last_name, specialty, contact_number, email) values (106, 'Betteann', 'Petrashkov', 'Orthopedics', '856 251 0381', 'bpetrashkov5@google.com.br');
insert into doctors (doctor_id, first_name, last_name, specialty, contact_number, email) values (107, 'Robina', 'Guilford', 'Neurology', '114 699 6611', 'rguilford6@unesco.org');
insert into doctors (doctor_id, first_name, last_name, specialty, contact_number, email) values (108, 'Whitby', 'Rubbens', 'Cardiology', '646 239 1747', 'wrubbens7@opera.com');
insert into doctors (doctor_id, first_name, last_name, specialty, contact_number, email) values (109, 'Modestine', 'Worboys', 'Dermatology', '159 243 7411', 'mworboys8@quantcast.com');
